...
export const indianFoods: IndianFood[] = [
  { name: "Roti / Chapati", serving: "1 medium (30g)", calories: 80, protein: 3, carbs: 15, fats: 1 },
  ...
  { name: "Steamed Rice", serving: "1 katori (150g cooked)", calories: 195, protein: 4, carbs: 43, fats: 0 },
  ...
  { name: "Idli", serving: "1 piece", calories: 40, protein: 2, carbs: 8, fats: 0 },
  { name: "Dosa (plain)", serving: "1 piece", calories: 130, protein: 3, carbs: 22, fats: 4 },
  ...
  { name: "Chai (with milk & sugar)", serving: "1 cup (150ml)", calories: 60, protein: 2, carbs: 9, fats: 2 },
